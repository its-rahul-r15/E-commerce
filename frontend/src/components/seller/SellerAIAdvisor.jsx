...
const SellerAIAdvisor = ({ sellerData }) => {
    ...
    return (
        <div className="bg-white border border-[var(--athenic-gold)] border-opacity-20 shadow-sm overflow-hidden">
            {/* Header */}
            <div className="bg-[var(--athenic-blue)] px-6 py-4 flex items-center justify-between">
                <div className="flex items-center space-x-3">
                    <span className="text-xl">🤖</span>
                    <div>
                        <h3 className="text-xs font-serif uppercase tracking-[0.2em] text-white">AI Business Advisor</h3>
                        <p className="text-[9px] font-serif text-white opacity-50 tracking-widest">Powered by Trinetri AI</p>
                    </div>
                </div>
                <button
